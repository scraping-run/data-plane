    ...
    <Panel className="recentList flex-row! justify-between px-0!">
      <SimpleBar style={{ flex: 1, overflowY: "hidden" }} id="reverse_scroll">
        <HStack className="flex-1 flex-nowrap" height="36px" data-simplebar>
              ...
              recentFunctionList.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={clsx(
                      "group ml-0! flex h-full w-28 cursor-pointer items-center justify-between border-y-2 px-3 text-[13px] font-medium",
          ...
          <div
            className={clsx(
              "ml-0! flex h-full flex-1 border-b-2 ",
      ...
      <HStack
        ...
        height="36px"
        className={clsx(
          "flex justify-end border-b-2 pr-2",
          !darkMode ? "border-[#EEF0F2] " : "border-[#1A202C]",
        )}
        spacing={3}
      >
