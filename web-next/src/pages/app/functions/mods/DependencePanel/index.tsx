                  ...
                  return (
                    ...
                    >
                      ...
                      <div className=" flex w-[100px]">
                        <span className="inline-block grow overflow-hidden text-ellipsis whitespace-nowrap">
                          {packageItem?.spec}
                        </span>
                        {!packageItem?.builtin ? (
                ...
                return (
                  ...
                  >
                    <div className="text-second">
                      <span className="inline-block w-40 overflow-hidden text-ellipsis whitespace-nowrap">
                        {packageItem?.name}
                      </span>
                    </div>
                    <div className="inline-block w-20 overflow-hidden text-ellipsis whitespace-nowrap text-second">
