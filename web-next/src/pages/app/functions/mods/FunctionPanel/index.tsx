...
export default function FunctionList() {
        ...
        if (
          ...
          return (
            <span className="flex select-none items-center">
              <span>{item.desc}</span>
              <div className="ml-1 translate-y-px scale-[.85] opacity-75">{` ${
          ...
          return (
            <span className="flex select-none items-center">
              ...
              <div className="ml-1 translate-y-px scale-[.85] opacity-75">{` ${item.desc}`}</div>
            </span>
          );
        }
      })();
            ...
            {!item.children?.length && (
              <HStack spacing={1}>
                {functionCache.getCache(item?._id, (item as any)?.source?.code) !==
                  ...
                  <span className="mt-px inline-block h-1 w-1 flex-none rounded-full bg-rose-500"></span>
                )}
  ...
  return (
    <Panel className="grow overflow-hidden">
      ...
      <div className="funcList grow" style={{ overflowY: "auto" }}>
