    ...
    <div className={clsx("flex flex-col px-28 2xl:px-48", colorMode === "dark" ? "" : "bg-white")}>
      ...
      <div className="flex h-full pt-9">
        ...
        <div className="flex h-[70vh] w-1/5 flex-col">
          <Box className={clsx("border-b", functionList.length === 0 && "pb-2")}>
          ...
          <Box className={clsx("mt-3 border-b", packageList.length === 0 && "pb-2")}>
          ...
          <Box className={clsx("mt-3 border-b", environments.length === 0 && "pb-2")}>
            <div className="flex items-center justify-between">
