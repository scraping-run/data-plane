...
const TemplateInfo = (props: { functionTemplate: TFunctionTemplate; usedBy: any }) => {
  ...
  return (
    <div>
      ...
      <Box className={clsx("border-b pt-5", packageList.length === 0 && "pb-2")}>
      ...
      <Box className={clsx("border-b pt-5", environments.length === 0 && "pb-2")}>
      ...
      <Box className={clsx("border-b", usedBy?.list?.length === 0 && "pb-2")}>
