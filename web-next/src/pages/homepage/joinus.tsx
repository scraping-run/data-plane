        ...
        <div className="m-16 w-2/5">
          ...
          <div className="flex justify-start gap-4">
            <a href={siteSettings.laf_discord_url?.value} target="_blank" rel="noreferrer">
              <div className="flex h-12 w-36 flex-row items-center	 justify-center gap-2 rounded-md border border-blue-200 border-opacity-30 bg-linear-to-r from-[#394DFF1A] to-[#66E3FF33]">
            ...
            <a href={siteSettings.laf_wechat_url?.value} target="_blank" rel="noreferrer">
              <div className="flex h-12 w-36 flex-row items-center	 justify-center gap-2 rounded-md border border-green-200 border-opacity-30 bg-linear-to-r from-[#2CE25E1A] to-[#1DFFD61A]">
            ...
            <a href={siteSettings.laf_forum_url?.value} target="_blank" rel="noreferrer">
              <div className="flex h-12 w-36 flex-row items-center justify-center gap-2 rounded-md border border-blue-300 border-opacity-30 bg-linear-to-r from-[#0B9DFF1A] to-[#4FC67E1A]">
